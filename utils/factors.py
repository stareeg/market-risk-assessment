...
Логика:
  ...
  2) очистка данных, которой требует п. 2.b:
...
Сами риск-факторы (через PCA) считаются в pca_tools.py и в тетрадке.
"""
...
# =========================================================================
#  Очистка: сплиты и календарные разрывы (п. 2.b)
# =========================================================================
def detect_splits(prices: pd.DataFrame, ratio_threshold: float = 3.0) -> pd.DataFrame:
    ...
    это почти наверняка дробление/консолидация акций (сплит), а не рыночное движение.
